...
namespace лаба_три
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            рекурсивнымиФункциямиToolStripMenuItem.Enabled = false; chart1.Series[0].BorderWidth = 3;
        ...
        {
            dataGridView1.Rows[count].Cells[vid_sort].Value = sr; dataGridView2.Rows[count].Cells[vid_sort].Value = obm;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns[4].HeaderText = "Рекурсивная вставками";
            dataGridView1.Columns[5].HeaderText = "Быстрая сортировка";
            ...
            dataGridView2.Columns[4].HeaderText = "Рекурсивная вставками";
            dataGridView2.Columns[5].HeaderText = "Быстрая сортирвока";
            dataGridView1.ColumnCount = 6;
            dataGridView2.ColumnCount = 6;
            ...
            ArraySort sort_r_insert = new ArraySort();
            ...
            for (n = Convert.ToInt32(numericUpDown1.Value); n <= Convert.ToInt32(numericUpDown2.Value); n += Convert.ToInt32(numericUpDown3.Value))
            {
                ...
                textBox1.Text += "Исходный массив " + Environment.NewLine; output_textBox(base_a, n);
                ...
                textBox1.Text += "Сортировка выбором " + Environment.NewLine; output_textBox(sort_select.a, n);
                ...
                textBox1.Text += "Сортировка вставками " + Environment.NewLine; output_textBox(sort_insert.a, n);
                ...
                textBox1.Text += "Сортировка пузырьком " + Environment.NewLine; output_textBox(sort_bubble.a, n);
                output_dataGridView(count, sr, obm, 3);
                chart3.Series[0].Points.AddXY(n, sr);
                chart3.Series[1].Points.AddXY(n, obm);

                sort_r_insert.a = (int[])base_a.Clone();
                sr = 0; obm = 0;
                sort_r_insert.insertionSortRecursive(sort_r_insert.a, sort_r_insert.a.Length,ref sr, ref obm); 
                textBox1.Text += "Рекурсивная сортировка вставками" + Environment.NewLine; output_textBox(sort_r_insert.a, n);
                ...
                sr = 0;obm = 0;
                sort_quick.QuickSort(sort_quick.a, 0, sort_quick.a.Length - 1,ref sr,ref obm);
                textBox1.Text += "Быстрая сортировка" + Environment.NewLine; output_textBox(sort_quick.a, n);
        ...
        private void сохранитьВсеГрафикиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            сохранитьГрафикиРекурсивнойСортировкиВставкамиToolStripMenuItem_Click(sender,e);
            сохранитьГрафикиБыстройСортировкиToolStripMenuItem_Click(sender, e);
        }   
        ...
        private void сохранитьГрафикВортировкиВыборомToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void сохранитьГрафикСортировкиПузырькомToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                saveGr2.Title = "Сохранить график как ..."; saveGr2.Filter = "*.jpg|*.jpg";
        ...
        private void сохранитьГрафикиРекурсивнойСортировкиВставкамиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog saveGr2 = new SaveFileDialog())
            {
                saveGr2.Title = "Сохранить график как ..."; saveGr2.Filter = "*.jpg|*.jpg";
                saveGr2.AddExtension = true;
                saveGr2.FileName = "InsertRec";
                if (saveGr2.ShowDialog() ==
                System.Windows.Forms.DialogResult.OK)
                {
                    chart3.SaveImage(saveGr2.FileName,
        ...
        private void сохранитьГрафикиБыстройСортировкиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            using (SaveFileDialog saveGr2 = new SaveFileDialog())
            {
                saveGr2.Title = "Сохранить график как ..."; saveGr2.Filter = "*.jpg|*.jpg";
                saveGr2.AddExtension = true;
                saveGr2.FileName = "Quick";
                if (saveGr2.ShowDialog() ==
                System.Windows.Forms.DialogResult.OK)
                {
                    chart3.SaveImage(saveGr2.FileName,
